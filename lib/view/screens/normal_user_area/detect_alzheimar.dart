      ...
      body: Obx(() => Column(
        ...
        children: [
          ...
          controller.selectedImages.isEmpty
            ...
            child: const Text(
                "We Have Developed an Artificial Intelligence Doctor Who Never Makes A Mistake, Trust Him."),
          )
              : const Text(""),
                  ...
                  child: Column(
                    children: [
                      Image(
                          height: 120,
                          image:
                          AssetImage(dark ? TImages.takephoto : TImages.takephoto)),
...
class AlzheimarDetectionController extends GetxController {
  ...
  Future<void> getImage(ImageSource imageSource) async {
    ...
    if (pickedFile != null) {
      var imageWithDateTime =
      ImageWithDateTime(pickedFile.path, DateTime.now());
